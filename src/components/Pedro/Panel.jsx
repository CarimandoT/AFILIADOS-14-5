        ...
        data.forEach((fila, index) => {
          ...
          const buscarValor = (palabraClave) => {
            ...
            return llaveEncontrada
              ? String(fila[llaveEncontrada]).trim()
              : "";
          };

          const dni = buscarValor("dni")
            .replace(/\D/g, "");
      ...
      <header className={styles.header}>
        ...
        <div>
          ...
          <p className={styles.subtitulo}>
            Sistema de gestión ·
            {personas.length} registros totales
          </p>
        </div>
